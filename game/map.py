...
class Map:
    def __init__(self, radius: int):
        ...
        rain_forest = Cell("in|a rain forest", icon="🌴", water_multiplier=2)
        dry_forest = Cell("in|a dry forest", icon="🌵", food_multiplier=0, water_multiplier=0)
        ...
        self.cells = {
            (x, y): random.choices([forest, lake, rain_forest, dry_forest], weights=[2, 1, 1, 1])[0]
